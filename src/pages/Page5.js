...
export class Page5 extends PageBase {
    constructor(w, h) {
        super(w, h);
        ...
        // Custom Page 5 images
        const assets = [
            { url: '/assets/images/page5/2.png', x: 0, y: h * 0.001, z: -h * 0.25, scale: 0.7 },
            { url: '/assets/images/page5/1.png', x: 0, y: h * 0.05, z: -h * 0.05, scale: 0.4 } 
        ];
